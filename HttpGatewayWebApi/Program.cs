...
namespace HttpGatewayWebApi
{
    public class Program
    {
        ...
        {
            ServiceRuntime.RegisterServiceAsync("HttpGatewayWebApiType", context => new WebHostingService(context, "ServiceEndpoint")).GetAwaiter().GetResult();

            Thread.Sleep(Timeout.Infinite);
        }

        /// <summary>
        /// Service sans état spécialisé pour l'hébergement d'applications web ASP.NET Core.
        /// </summary>
